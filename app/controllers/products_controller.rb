class ProductsController < ApplicationController
  ...
  def destroy
    @product.destroy
    respond_to do |format|
      format.html { redirect_to "/static_pages/landing_page", notice: 'Product was successfully destroyed.' }
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :description, :condition, :image_url, :colour, :price)
    end
end
